    ...
    fun show(activity: Activity, onDone: () -> Unit = {}) {
        ...
        val pages = listOf(
            Page("Welcome to OverlAI",
                "Check any image for signs of AI generation — right from your screen, in a couple of taps.",
                ::logoIcon),
            Page("The floating bubble",
                "Activate the overlay and a small bubble appears over everything. Tap it to open the menu, then tap the camera to check what's on screen.",
                ::bubbleIcon),
            ...
            Page("Detector and sharing",
                "The Detector tab checks images from your gallery.\n\nOr share a picture to “Check with OverlAI” straight from any other app.",
                ::detectorIcon),
